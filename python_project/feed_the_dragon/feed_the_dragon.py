...
DRAGON_VELOCITY = 30
BUFFER_DISTANCE = -150
GAME_FOLDER ='e:/projects/python_project/feed_the_dragon/'
#create a window and set the title
display_surface = pygame.display.set_mode((WINDOW_WIDTH, WINDOW_HEIGHT))
pygame.display.set_caption('Feed the Dragon')

#setup the background
background = pygame.image.load(GAME_FOLDER+'dragon_night.jpg')
...
#font
game_font = pygame.font.Font(GAME_FOLDER+'AttackGraffiti.ttf', 32) #fontname, fontsize
